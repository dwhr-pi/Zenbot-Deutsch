...
Installationszeit berägt ca. 20 Minuten.

___________________________________________________
die Node.js Version 8 oder bis 12 und nicht Version 14 verwenden.
___________________________________________________
...
BESSER MongoDB 4.2 oder 4.4 für arm64
Richtig*******************
...
G++, ist nicht Bestandteil von DietPi
...
Befolge dann die Anleitung in der build / building.md Datei, falls es hier zu komplikationen kommen sollte. 
...
ENDE MongoDB 4.4 für arm64, ob das auch bei der 4.4 funktioniert?
...
hierbei im Ordner etc/agp/source.list Datei editieren und den Ordner source.list.d korrigieren.
...
zenbot morpheus.5250$ zenbot sim --days 90 --profit_stop_enable_pct=10 --profit_stop_pct=1 --sell_rate=-0.006 --trend_ema=36 --period=1h
...
E:\_Bitcoin_Core\Eobot_FREE_Cloud_Mining_Review\_TraderBots\Zenbot\Zenbot strategies\Zenbot-Strategien · GitHub\zenbot_strategies-master
...
Daniel Rösgen, [31.03.21 22:17]
BinanceTraderbot

BotFather, [31.03.21 22:17]
Done! Congratulations on your new bot. You will find it at t.me/DWHRBinanceTraderbot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

Use this token to access the HTTP API:
1710029867:AAEwI_iBgi-jgEosQe1mba8JWPd54UbUssg
